...
alle$MONAT[alle$MONAT_Nr == "01"] <- "Jan"
alle$MONAT[alle$MONAT_Nr == "02"] <- "Feb"
alle$MONAT[alle$MONAT_Nr == "03"] <- "Mrz"
alle$MONAT[alle$MONAT_Nr == "04"] <- "Apr"
alle$MONAT[alle$MONAT_Nr == "05"] <- "Mai"
alle$MONAT[alle$MONAT_Nr == "06"] <- "Jun"
alle$MONAT[alle$MONAT_Nr == "07"] <- "Jul"
alle$MONAT[alle$MONAT_Nr == "08"] <- "Aug"
alle$MONAT[alle$MONAT_Nr == "09"] <- "Sep"
